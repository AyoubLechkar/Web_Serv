...
function generateQRCode() {
    ...
    const qrColor = document.getElementById('colorPicker').value;
    const bgColor = document.getElementById('bgColorPicker').value; // Get the selected background color
    ...
    qr = new QRCode(document.getElementById("qrcode"), {
        ...
        width: 128,
        height: 128,
        colorDark: qrColor, // Set the color of the dark modules (foreground)
        colorLight: bgColor // Set the background color
    });
